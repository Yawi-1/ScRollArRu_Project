  ...
  return (
    <div className="hidden lg:block">
      ...
      <div className="flex w-full items-center justify-center mt-2">
        <button onClick={()=>{toggleBuyModal()}} className="h-16 m-1 w-full border-2 rounded-lg border-slate-300 dark:border-slate-600 bg-amber-400 hover:bg-amber-500">Buy Now</button>
